          ...
          >
            ...
            <div className="mt-8 space-y-4">
              ...
              <button
                ...
                className={`w-full py-3.5 px-6 rounded-xl bg-gradient-to-r from-teal-600 to-emerald-600 hover:brightness-110 text-white font-bold text-sm shadow-lg shadow-teal-500/10 cursor-pointer transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed ${isAr ? 'font-arabic' : 'font-sans'}`}
              >
                {isLoggingIn ? (
                ...
                <span>{isAr ? "تسجيل الدخول المستند إلى جوجل" : "Login with Google"}</span>
              </button>
            </div>
